;(function (window) {
  ...
  let texts = ['MY DEARST', 'TODAY IS', 'OUR FIRST', 'VALENTINE\'S DAY', 'THOUGH WE ARE', 'FAR APART', 'MY HEART', 'MY DEEP LOVE', 'FOR YOU', 'HAVE NEVER LEFT',
'I HOPE', 'THIS CAN EXPRESS', ' 0.001 PERCENT','OF MY LOVE FOR YOU', 'THOUGH I KNOW','IT\'S NOT','REALLY POSSIBLE',
'ANYWAY','HAPPY','VALENTINE\'S DAY','LOVE YOU,','YHY']
